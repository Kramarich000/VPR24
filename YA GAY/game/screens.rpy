...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot (41, 255, 250, 85) action Start ()
        hotspot (41, 415, 355, 85) action ShowMenu ("load")
        hotspot (41, 595, 365, 85) action ShowMenu ("preferences")
        hotspot (41, 915, 220, 85) action Quit (confirm=True)
        hotspot (1617, 939, 270, 85) action ShowMenu ("help")
